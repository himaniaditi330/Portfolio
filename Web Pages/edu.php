...
<!-- Include navigation bar-->
 ...
 <a href="home.php" ><i class="fa fa-fw fa-home"></i>&nbsp Home</a>
  ...
  <a href="edu.php" class="active"><i class="fa fa-fw fa-graduation-cap"></i>&nbsp Education</a>
...
<!-- Include side bar-->
  ...
  <div class="main">
    ...
    <ul>
		<li>
			<p>M. Sc. (Mathematics) from Jadavpur University, Kolkata, INDIA .</p>
		</li>
		<li>
			<p>B. Sc. (Mathematics (Honors)) from Jadavpur University, Kolkata, INDIA .</p>
		</li>
		<li>
			<p>Diploma in Chinese Language from Barkatullah University, M. P. INDIA .</p>
		</li>
		<li>
			<p>Interpreter-ship in Chinese Language from School of Foreign Languages, Delhi, INDIA.</p>
		</li>
	</ul>
    <br>
