...
<!-- Include navigation bar-->
 <div class="navbar">
  ...
  <a href="reInt.php" class="active"><i class="fa fa-fw fa-book"></i>&nbsp Reseach Interests</a>
...
<!-- Include side bar-->
  ...
  <br>
    ...
    <ul>
		<li>
			<p>Design and analysis of block ciphers<p>
		</li>
		<li>
			<p>Design and analysis of cryptographic hash functions</p>
		</li>
		<li>
			<p>Multivariate public key cryptography</p>
		</li>
		<li>
